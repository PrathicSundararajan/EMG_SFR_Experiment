...
void loop()
{
  if (serial_string != "")
  {
  dataSent = String(current_time) + " " + String(serial_string);
...
{ 
  ...
  serial_string = adc_now; //slight EDIT
  //serial_string += String (adc_now) + "," + String (current_time - last_calls[0]) + "\n";
